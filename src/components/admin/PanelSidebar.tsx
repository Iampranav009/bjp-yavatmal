...
const panelNavItems = [
    { label: "Dashboard", href: "/admin/a/dashboard", icon: LayoutDashboard },
    { label: "Members", href: "/admin/a/members", icon: Users },
    { label: "Event Posts", href: "/admin/a/events", icon: CalendarDays },
    { label: "Meetings", href: "/admin/a/meetings", icon: CalendarCheck },
    { label: "Tasks", href: "/admin/a/tasks", icon: ClipboardList },
];
...
export default function PanelSidebar({
    ...
    const isActive = (href: string) => {
        if (href === "/admin/a/dashboard") {
            return pathname === "/admin/a" || pathname === "/admin/a/dashboard";
        }
        ...
        <>
            ...
            <div className="p-4 border-t border-slate-200">
                <div className="px-4 py-3 mb-2">
                    ...
                    <span className="inline-block mt-1 text-[9px] font-bold uppercase tracking-wider px-1.5 py-0.5 rounded-full bg-slate-100 text-slate-500">
                        Admin
                    </span>
                </div>
                <button
