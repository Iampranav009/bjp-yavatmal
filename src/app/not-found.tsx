...
export default function NotFound() {
    return (
        <div className="min-h-screen bg-[#F4F6F8]er flex flex-col items-center justify-center text-center px-6">
            <h1 className="text-[14rem] font-oswald text-saffron/20 leading-none select-none">
                404
            </h1>
            <h2 className="text-4xl md:text-6xl font-oswald text-slate-900 tracking-widest -mt-10 mb-4">
                Page Not Found
            </h2>
